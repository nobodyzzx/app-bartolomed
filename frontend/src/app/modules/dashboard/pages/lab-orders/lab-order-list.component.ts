...
export class LabOrderListComponent implements OnInit {
  ...
  private static readonly RUTA = '/dashboard/lab-orders'
  ...
  private recordarVista(): void {
    ...
    this.listState.guardar(LabOrderListComponent.RUTA, estado)
  ...
  private restaurarVista(): void {
    const guardado = this.listState.recuperarSiVuelve(LabOrderListComponent.RUTA)
