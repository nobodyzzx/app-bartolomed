...
export class MainDashboardComponent implements OnInit {
  ...
  loadDashboardData(): void {
    ...
    this.stats = {
      ...
      { id: 1, patientName: 'María García', doctorName: 'Dr. Rodríguez', time: '09:00', status: 'confirmed', type: 'Consulta General' },
      { id: 2, patientName: 'Juan Pérez', doctorName: 'Dr. López', time: '10:30', status: 'pending', type: 'Cardiología' },
      { id: 3, patientName: 'Ana Martín', doctorName: 'Dr. González', time: '11:15', status: 'confirmed', type: 'Dermatología' },
      { id: 4, patientName: 'Carlos Ruiz', doctorName: 'Dr. Hernández', time: '12:00', status: 'cancelled', type: 'Neurología' },
      { id: 5, patientName: 'Laura Sánchez', doctorName: 'Dr. Torres', time: '14:30', status: 'confirmed', type: 'Pediatría' }
    ];
